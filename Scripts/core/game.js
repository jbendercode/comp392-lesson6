...
function init() {
    ...
    emptyObject.position.set(10, 0, 0);
    cube.add(emptyObject);
    console.log("Added Empty Object to cube object...");
    childCube = new gameObject(new CubeGeometry(2, 2, 2), new LambertMaterial({ color: 0xff0000 }), 2, 2, 2);
    emptyObject.add(childCube);
    console.log("Added Child Cube Primitive to empty object...");
